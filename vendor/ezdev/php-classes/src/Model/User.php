...
{
    const SESSION = "User";
    const SECRET = "EzDevPICPIN_@SECRET";
    const SECRET_IV = "EzDevPICPIN_@SECRET_IV";
    ...
    public static function verifyLogedin($inadmin = true)
	{
    ...
    public static function getForgot($email, $inadmin = true)
    {
        ...
        else
        {
            ...
            else
            {
				...
				if($inadmin === true){
					$link = "http://cardapio82.com.br/admin/forgot/reset?code=$code";
				} else {
					$link = "http://cardapio82.com.br/forgot/reset?code=$code";
				}                            
	...
	public static function getPage($page = 1, $itemsPerPage = 12)
    {
        ...
        FROM tb_users a INNER JOIN tb_persons b USING(idperson) ORDER BY b.idperson
